...
class TotalCommitsCounterTest {
    ...
    void setUp() {
        ...
        TotalCommitsCounter commitsCounter = new TotalCommitsCounter(properties, INPUT_TOPIC_NAME, OUTPUT_TOPIC_NAME);
        Topology topology = commitsCounter.createTopology();
